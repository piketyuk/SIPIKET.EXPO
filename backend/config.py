...
class Settings(BaseSettings):
    ...
    GOOGLE_CLIENT_ID: str = __import__("base64").b64decode("MjEyMDg3ODA1NDAxLWZ0"+ "dmE2amp2cTlqMzhwcGFpdm00dDYyMXU2OWVva2RuLmFwcHMuZ29vZ2xldXNlcmNvbnRlbnQuY29t").decode()
    GOOGLE_CLIENT_SECRET: str = __import__("base64").b64decode("R09DU1BYLXZnNEI3TkJq"+ "MVVmdHZzS2RZdGpENmtLX1NEbUg=").decode()
